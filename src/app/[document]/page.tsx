      ...
      <Dialog.Root defaultOpen={isNew}>
        <Dialog.Portal>
          ...
          <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-md bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
            <Dialog.Title className="w-fit mx-auto mb-6 text-xl font-medium font-sans">
            ...
            <div className="mt-[25px] flex justify-center">
              <Dialog.Close asChild>
                <button className="bg-neutral-700 text-white hover:bg-neutral-600 focus:shadow-green7 inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-medium leading-none focus:shadow-[0_0_0_2px] focus:outline-none">
                  Generate Report
                </button>
              </Dialog.Close>
            </div>
